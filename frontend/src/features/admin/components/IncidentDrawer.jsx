...
export default function IncidentDrawer({ incident, engineers, onClose, onAssign, onStatus, onDecide, onNote }) {
  ...
  return (
    <Drawer
      ...
      open={!!i}
      onClose={onClose}
      PaperProps={{ sx: { width: 480, maxWidth: '100%', bgcolor: admin.bg, borderRadius: '16px 0 0 16px' } }}
